...
//Finding all items in the Posts collection and render it into our home page.
...
app.get("/compose", function(req, res){
 ...
 //Saving the title and the post into our blogDB database.
...
app.get("/posts/:postId", function(req, res){
  ...
  //We have rendered the post into the designated page.
